...
export default function Home(): ReactElement {
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => e.key === "Escape" && setShowNotice(false)
      ...
      <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-black/30 border-b border-purple-900/30">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          {!isMobile && (
            ...
            >
              <button onClick={() => scrollTo(aboutRef)} className="text-sm hover:text-purple-400 transition-colors relative group">
                ABOUT
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-500 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => scrollTo(projectsRef)} className="text-sm hover:text-blue-400 transition-colors relative group">
                PROJECTS
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => scrollTo(skillsRef)} className="text-sm hover:text-cyan-400 transition-colors relative group">
                SKILLS
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-cyan-500 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => scrollTo(experienceRef)} className="text-sm hover:text-green-400 transition-colors relative group">
                EXPERIENCE
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => scrollTo(contactRef)} className="text-sm hover:text-pink-400 transition-colors relative group">
                CONTACT
      ...
      <main>
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 z-20 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.8, duration: 0.8 }}>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.2 }} className="max-w-2xl mx-auto">
                <p className="text-lg md:text-xl text-gray-300 mb-8">Full Stack Developer</p>
              ...
              >
                <div className="relative">
                  <div className="aspect-square rounded-2xl overflow-hidden border border-purple-500/30 shadow-lg shadow-purple-500/10">
                    <img src="images/Me.jpg" alt="Developer Portrait" className="w-full h-full object-cover mix-blend-luminosity opacity-80" />
                  </div>
              ...
              >
                <div className="backdrop-blur-sm bg-black/30 p-6 md:p-8 rounded-2xl border border-purple-500/20 shadow-lg shadow-purple-500/5">
                  ...
                  <p className="text-gray-300 mb-6">
                    An independent and self-motivated professional with strong programming, algorithms, and problem-solving skills. I specialize in
                    building robust, scalable applications using .NET, Azure and Angular with a focus on healthcare solutions and IoT technologies.
                  </p>
                  <p className="text-gray-300 mb-6">
                    With a passion for clean code and innovative solutions, I create seamless experiences that bridge the gap between complex backend
                    systems and intuitive user interfaces. My expertise spans from microservices architecture to CI/CD pipelines and cloud deployment.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <Badge className="bg-purple-900/50 hover:bg-purple-800/50 text-purple-300 border border-purple-500/30">.NET Core</Badge>
                    <Badge className="bg-blue-900/50 hover:bg-blue-800/50 text-blue-300 border border-blue-500/30">Angular</Badge>
                    <Badge className="bg-cyan-900/50 hover:bg-cyan-800/50 text-cyan-300 border border-cyan-500/30">Azure</Badge>
                    <Badge className="bg-green-900/50 hover:bg-green-800/50 text-green-300 border border-green-500/30">IoT</Badge>
                    <Badge className="bg-pink-900/50 hover:bg-pink-800/50 text-pink-300 border border-pink-500/30">CI/CD</Badge>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section ref={projectsRef} className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">Featured Projects</span>
              </h2>
        ...
        <section ref={skillsRef} className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-green-500">Technical Skills</span>
              </h2>
                      ...
                      <div className="backdrop-blur-sm bg-black/30 p-6 rounded-xl border border-cyan-500/20 shadow-lg shadow-cyan-500/5">
                        ...
                        <div className="space-y-2">
                          ...
                          <Progress value={skill.level} className="h-2 bg-gray-800">
                            <div className="h-full bg-gradient-to-r from-cyan-500 to-green-500 rounded-full" style={{ width: `${skill.level}%` }} />
                          </Progress>
                        </div>
                      </div>
                    </motion.div>
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">Achievements & Certifications</span>
              </h2>
              <div className="w-20 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto rounded-full" />
            </motion.div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} viewport={{ once: true, margin: "-100px" }}>
                <div className="backdrop-blur-sm bg-black/30 p-6 rounded-xl border border-blue-500/20 shadow-lg shadow-blue-500/5 h-full">
                  <h3 className="text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Certifications</h3>
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">Advanced SQL programming and database optimization techniques</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true, margin: "-100px" }}>
                <div className="backdrop-blur-sm bg-black/30 p-6 rounded-xl border border-purple-500/20 shadow-lg shadow-purple-500/5 h-full">
                  <h3 className="text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Awards & Recognition</h3>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">Recognized for exceptional problem-solving skills and algorithm optimization</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <div className="mr-3 mt-1 w-2 h-2 rounded-full bg-purple-500"></div>
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">Project Management, Structural Analysis, Decision Making, IoT Development</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <div className="mr-3 mt-1 w-2 h-2 rounded-full bg-purple-500"></div>
        ...
        <section ref={experienceRef} className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-pink-500">Work Experience</span>
              </h2>
            ...
            <div className="max-w-3xl mx-auto">
              {experiences.map((experience, index) => (
                <TimelineItemComponent key={index} experience={experience} index={index} isLast={index === experiences.length - 1} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section ref={contactRef} className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500">Get In Touch</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              >
                <div className="backdrop-blur-sm bg-black/30 p-6 md:p-8 rounded-2xl border border-pink-500/20 shadow-lg shadow-pink-500/5 h-full">
                  <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">Contact Information</h3>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:kartikpatadia21@gmail.com" className="text-white hover:text-pink-400 transition-colors">
        ...
        <AnimatePresence>
          {showNotice && (
            ...
            >
              {/* Dim background */}
              <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" onClick={() => setShowNotice(false)} />
              ...
              <motion.div
                ...
                transition={{ duration: 0.25 }}
                className="relative z-10 w-[92vw] max-w-xl rounded-2xl border border-purple-500/30 bg-black/70 p-6 md:p-8 shadow-[0_0_60px_-10px_rgba(168,85,247,0.35)]"
              >
                <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-pink-600/10 via-purple-600/10 to-blue-600/10 pointer-events-none" />

                <div className="relative space-y-4">
                  <h3 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">
                    🚧 This button is under construction… but I reply fast!
                  </h3>
                  <p className="text-gray-300 leading-relaxed">
                    This form is doing push-ups behind the scenes. In the meantime humans still win: drop me an{" "}
                    <span className="text-pink-300">email</span> or ping me on <span className="text-purple-300">WhatsApp</span>.
                  </p>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                    <a
                      href="mailto:kartikpatadia21@gmail.com"
                      className="inline-flex items-center justify-center rounded-xl border border-pink-500/40 bg-pink-500/10 px-4 py-3 text-pink-200 hover:bg-pink-500/20 transition"
                    >
                      <Mail className="mr-2 h-4 w-4" /> Email Me
                    </a>
                    <a
                      href="https://wa.me/919560970597"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center rounded-xl border border-purple-500/40 bg-purple-500/10 px-4 py-3 text-purple-200 hover:bg-purple-500/20 transition"
                    >
                  ...
                  <div className="pt-4 flex items-center justify-between">
                    <span className="text-xs text-gray-500">Tip: include your project timeline & stack for a quicker reply.</span>
                    <Button
                      onClick={() => setShowNotice(false)}
                      variant="outline"
                      className="border-blue-500/40 text-blue-300 hover:bg-blue-900/20 hover:text-blue-200 hover:border-blue-400/60"
                    > Close
                    </Button>
                  </div>
                </div>
